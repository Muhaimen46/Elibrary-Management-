<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminmemebermanagement.aspx.cs" Inherits="WebApplication3.adminmemebermanagement" %>
                     ...
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="member_id" DataSourceID="SqlDataSource1">
                            <Columns>
                                ...
                                <asp:BoundField DataField="district" HeaderText="HomeTown" SortExpression="district" />
                            </Columns>
                         </asp:GridView>
                     </div>
                  </div>
